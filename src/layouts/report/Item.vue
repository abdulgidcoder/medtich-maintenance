  ...
  <li class="report-item">
    ...
    >
      <div class="report-item-wrap">
        ...
        <p>آخر تحديث {{ $dateTime(report.modified) }}</p>
        <div class="report-meta">
          <span class="report-date"
            ><Icon name="calendar" /> {{ $dateTime(report.date) }}</span
          >
          <span class="report-cost"
            ><Icon name="dollar" />{{ report.acf["expected_cost"] }} جنية</span
          >
          <span class="report-cost"
          ...
          <span class="report-status">
            <span
              ...
              >{{
                report.acf["status"] == "active"
                  ? "نشط"
                  : report.acf["status"] == "pending"
                  ? "قيد الانتظار"
                  : report.acf["status"] == "block"
                  ? "مرفوض"
                  : ""
              }}</span
            >
